  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body">
        <form id="connexionForm" action="indexView.php" method="post">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-light text-dark" id="connexionButton">Connexion</button>
      </div>
        
      <a href="View/formView.php" class="text-light text-center h6 font-weight-bold">Ou bien inscrivez vous</a>
    </div>
  </div>
</div>
